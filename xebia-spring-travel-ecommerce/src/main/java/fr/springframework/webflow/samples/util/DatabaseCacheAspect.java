...
import fr.springframework.webflow.samples.booking.Hotel;
import fr.springframework.webflow.samples.booking.SearchCriteria;
...
public class DatabaseCacheAspect {
    ...
    /**
     * {@link fr.springframework.webflow.samples.booking.BugService}
     */
    @Autowired
	...
	@Around("execution(* fr.springframework.webflow.samples.booking.JpaBookingService.findHotels(fr.springframework.webflow.samples.booking.SearchCriteria)) && args(criteria)")
